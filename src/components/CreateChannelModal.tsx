          ...
          {mode === 'create' ? (
            ...
            >
              <p className="text-sm text-foreground/70">
                Use a concise room name. The channel will be created immediately and the conversation will open as soon
                as you join it.
              </p>
              ...
              <div className="space-y-2">
                {filteredRooms.length > 0 ? (
                  filteredRooms.map((room) => (
                    <div
                      key={room.id}
                      className="flex items-center justify-between p-3 bg-background/40 border border-border/30 rounded-xl hover:bg-background/80 transition-colors"
                    >
