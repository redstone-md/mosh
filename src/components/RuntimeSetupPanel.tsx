...
export function RuntimeSetupPanel({
  ...
  const inputClasses =
    'w-full bg-background border border-border/50 rounded-lg px-4 py-2 text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all'
