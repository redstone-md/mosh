export const ruTranslations = {
    ...
    identityTransfer: {
      ...
      description: 'Экспортируй локальную signing identity в зашифрованный transfer package и импортируй её на другое устройство с MOSH.',
      ...
      handoffDescription: 'Перенеси эту identity на другую машину с MOSH через QR, короткий код проверки или сам transfer package.',
      ...
      deepLinkDescription: 'MOSH получил identity transfer link из системы. Введи пароль переноса, чтобы применить identity на этом устройстве.',
      deepLinkWarningTitle: 'Это заменит текущую identity',
      deepLinkWarning: 'После импорта устройство начнёт подписывать локальные архивы и trust-действия перенесённой identity вместо текущей.',
      ...
      rollbackDescription: 'Восстанови прежнюю signing identity, которую MOSH сохранил на этом устройстве перед последним импортом или откатом.',
    ...
    createSpace: {
      ...
      description: 'Подключись к каналу, открой личную комнату, собери локальную структуру групп или примени mesh-инвайт.',
