export const ruTranslations = {
  ...
  identityTransfer: {
    ...
    sameIdentity: 'Этот перенос совпадает с identity, которая уже активна на устройстве.',
    replaceIdentity: (current: string, incoming: string) => `Это заменит ${current} на ${incoming}.`,
