export const ruTranslations = {
  ...
  onboarding: {
    ...
    steps: {
      ...
      ports: {
        title: 'Подключение',
        subtitle: 'MOSH может выбрать порт автоматически и использовать tracker, LAN и NAT bootstrap.',
      },
      discovery: {
  ...
  inviteReview: {
    ...
    mesh: 'Mesh',
    room: 'Комната',
    startupPeer: 'Bootstrap-путь',
    noStartupPeer: 'Автообнаружение через tracker/LAN',
    unavailableFingerprint: 'В этом инвайте отпечатка нет',
    discovery: (mode: string) => `Режим обнаружения: ${mode}`,
    discoveryLan: 'tracker + LAN + NAT bootstrap',
    discoveryDirect: 'tracker + NAT bootstrap',
