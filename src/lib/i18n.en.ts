export const enTranslations = {
  ...
  onboarding: {
    ...
    steps: {
      ...
      ports: {
        title: 'Connectivity',
        subtitle: 'MOSH can choose a port automatically and use tracker, LAN, and NAT bootstrap.',
      },
      discovery: {
  ...
  form: {
    ...
    startupPeer: 'Advanced Bootstrap Peer',
    listenPort: 'Listen Port',
    trackerBootstrap: 'Tracker Bootstrap',
    lanDiscovery: 'Enable LAN discovery',
    startupPeerPlaceholder: 'optional host:port',
  },
  sidebar: {
  ...
  messages: {
    ...
    noMessagesSystem: 'System updates will appear here as soon as the runtime has something to report.',
    ...
    failed: 'Send failed',
    edit: 'Edit message',
    editDescription: 'Apply a local edit overlay for this message on this device.',
    saveEdit: 'Save edit',
    hideMessage: 'Hide message',
    restoreMessage: 'Restore message',
    editedLocally: 'Edited locally',
    hiddenLocally: 'Hidden on this device',
    retrySend: 'Retry',
  ...
  inviteReview: {
    ...
    mesh: 'Mesh',
    room: 'Room',
    startupPeer: 'Bootstrap path',
    noStartupPeer: 'Automatic tracker/LAN discovery',
  ...
  identityTransfer: {
    ...
    description:
      'Export your local signing identity into an encrypted transfer package and import it on another MOSH device.',
    ...
    handoffDescription:
      'Move this identity to another MOSH machine with a QR handoff, a short verification code, or the raw transfer package.',
    ...
    stepImport:
      '3. On the other device, paste the package into Identity transfer and import it with the same passphrase.',
    packagePreview: 'Package preview',
    copyPackage: 'Copy package',
    deepLinkTitle: 'Import transferred identity',
    deepLinkDescription:
      'MOSH received an identity transfer link from the system. Enter the handoff passphrase to apply it on this device.',
    ...
    rollbackDescription:
      'Restore a previously active signing identity kept on this device before the last import or rollback.',
